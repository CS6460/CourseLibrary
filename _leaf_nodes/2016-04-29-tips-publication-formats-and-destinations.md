...
The following table gives some upcoming conferences. As far as the final paper
for this class is concerned, you need only select the conference you think is
most applicable to your work and write a paper in its format. Deadlines, locations,
and dates are provided just in case you want to make sure to select a conference
where publishing is an option.
